export function Footer() {
    return (
        <div>
            <footer className="daisy-footer bg-base-200 text-base-content p-10">
                <aside>
                    <svg
                        width="50"
                        height="50"
                ...
                <nav>
                    ...
                    <a className="daisy-link daisy-link-hover">Branding</a>
                    <a className="daisy-link daisy-link-hover">Design</a>
                    <a className="daisy-link daisy-link-hover">Marketing</a>
                    <a className="daisy-link daisy-link-hover">Advertisement</a>
                </nav>
                <nav>
                    ...
                    <a className="daisy-link daisy-link-hover">Jobs</a>
                    <a className="daisy-link daisy-link-hover">Press kit</a>
                </nav>
                <nav>
